...
public class ResponseConstants {
    ...
    public static final int ERR_COMPANY_NAME_EMPTY = 1022;
    public static final String ERR_COMPANY_NAME_EMPTY_MSG = "Company name can not be empty!";

    public static final int ERR_COMPANY_ALREADY_REGISTERED = 1023;
    public static final String ERR_COMPANY_ALREADY_REGISTERED_MSG = "Company already registered!";
