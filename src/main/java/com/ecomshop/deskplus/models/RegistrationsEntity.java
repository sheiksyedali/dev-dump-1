...
public class RegistrationsEntity {
    ...
    private PrimaryMailEntity primaryMail;

    @OneToMany(cascade = CascadeType.ALL,fetch = FetchType.LAZY, mappedBy = "registration")
    private List<MediumMailgunEntity> mediumDefaultSupportMails;

    @OneToMany(cascade = CascadeType.ALL,fetch = FetchType.LAZY, mappedBy = "registration")
    private List<MediumGmailEntity> mediumGmails;
    ...
    public PrimaryMailEntity getPrimaryMail() {
        return primaryMail;
    }

    public void setPrimaryMail(PrimaryMailEntity primaryMail) {
        this.primaryMail = primaryMail;
    }

    public List<MediumMailgunEntity> getMediumDefaultSupportMails() {
        return mediumDefaultSupportMails;
    }

    public void setMediumDefaultSupportMails(List<MediumMailgunEntity> mediumDefaultSupportMails) {
        this.mediumDefaultSupportMails = mediumDefaultSupportMails;
    }

    public List<MediumGmailEntity> getMediumGmails() {
        return mediumGmails;
    }

    public void setMediumGmails(List<MediumGmailEntity> mediumGmails) {
        this.mediumGmails = mediumGmails;
    }
